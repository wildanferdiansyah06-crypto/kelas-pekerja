<<<<<<< C:/Users/ASUS/Documents/GitHub/kelas-pekerja/src/app/tentang/page.tsx
'use client';
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center lg:items-start">
              ...
              <div className="flex flex-col items-center md:items-start lg:items-center">
                <div className="relative">
                  ...
                  <div className="relative w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 lg:w-52 lg:h-52 aspect-square rounded-full overflow-hidden border-4 shadow-2xl">
                    <Image
...
>>>>>>> C:/Users/ASUS/.windsurf/worktrees/kelas-pekerja/kelas-pekerja-97bdf993/src/app/tentang/page.tsx
