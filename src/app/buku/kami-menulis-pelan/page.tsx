    ...
    <div className={`min-h-screen ${theme.bg} ${theme.text} relative overflow-hidden transition-colors duration-500`}>
      ...
      <div className="relative z-10 min-h-[90vh] flex flex-col justify-center items-center px-6 pt-24 pb-12">
        ...
        >
          ...
          >
            <motion.div 
              className={`h-px ${theme.accentBorder.replace('border', 'bg')} w-16 origin-right`}
              variants={lineExpand}
            />
            <motion.span 
            ...
            <motion.div 
              className={`h-px ${theme.accentBorder.replace('border', 'bg')} w-16 origin-left`}
              variants={lineExpand}
            />
          </motion.div>
          ...
          >
            <p className={`text-sm md:text-base leading-[1.8] ${theme.textMuted} font-light`}>
              {subtitleText}
              <motion.span
                className={`inline-block w-[2px] h-[1.2em] ${theme.accent.replace('text', 'bg')} ml-1 align-middle`}
                animate={{ opacity: [1, 0] }}
      ...
      <div className={`relative z-10 max-w-3xl mx-auto px-6 pb-32 ${theme.text}`}>
        ...
        >
          <motion.blockquote 
            className={`font-serif italic text-lg md:text-xl ${theme.accent} leading-[1.6]`}
            initial={{ opacity: 0 }}
        ...
        >
          <motion.p 
            className={`text-base md:text-lg leading-[2] ${theme.text} font-light text-center italic`}
            initial={{ opacity: 0 }}
