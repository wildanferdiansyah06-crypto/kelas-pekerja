...
import { ArrowRight, ChevronDown, BookOpen, Coffee } from "lucide-react";
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#faf8f5]/40 via-[#faf8f5]/70 to-[#faf8f5] dark:from-[#1a1816]/80 dark:via-[#1a1816]/60 dark:to-[#1a1816]" />
        </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-20">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
            <Link
              href="#tentang"
              className="flex flex-col items-center gap-2 text-xs tracking-[0.3em] uppercase opacity-40"
            >
              Scroll
      ...
      <section className="py-32 px-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <Link
              href="/buku"
              className="inline-flex items-center gap-2 text-sm tracking-[0.2em] uppercase opacity-60 hover:opacity-100"
            >
              Lihat Semua Buku
              <ArrowRight size={16} />
            </Link>
