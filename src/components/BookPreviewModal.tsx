  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="relative w-full max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-5xl max-h-[70vh] sm:max-h-[85vh] md:max-h-[80vh] overflow-y-auto bg-[#faf9f7] dark:bg-[#141210] rounded-lg sm:rounded-xl md:rounded-2xl shadow-2xl ring-1 ring-[#e5e2dd] dark:ring-stone-800 transform-gpu will-change-transform"
